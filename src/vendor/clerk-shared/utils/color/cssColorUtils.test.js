...
describe("stringToSameTypeColor(color)", function() {
  const cases = [
    ...
    ["rgb(100,100,100)", { r: 100, g: 100, b: 100, a: void 0 }],
    ["rgba(100,100,100,0.5)", { r: 100, g: 100, b: 100, a: 0.5 }],
    ["rgb(100,100,100)", { r: 100, g: 100, b: 100, a: void 0 }],
    ["rgba(100,100,100,0.5)", { r: 100, g: 100, b: 100, a: 0.5 }],
    ["hsl(244,66%,33%)", { h: 244, s: 0.66, l: 0.33, a: void 0 }],
...
describe("colorToSameTypeString(color)", function() {
  const cases = [
    ...
    ["#12ff12", "#12ff12"],
    ["#1ff", "#1ff"],
    [{ r: 100, g: 100, b: 100, a: void 0 }, "rgb(100,100,100)"],
    [{ r: 100, g: 100, b: 100, a: 0.5 }, "rgba(100,100,100,0.5)"],
    [{ h: 100, s: 0.55, l: 0.33, a: void 0 }, "hsl(100,55%,33%)"],
...
//# sourceMappingURL=cssColorUtils.test.js.map